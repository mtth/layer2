...
(function (root) {
   ...
   *
   */
  function Capture(dispatcher, keepAlive, opts) {
    ...
    this._read = function () {
      ...
      if (concurrency > 0 && !finishing && iters.length < batchHighWaterMark) {
        concurrency--;
        dispatcher.dispatch(batchSize, batchCb);
      }
  ...
  function Replay(fpath, opts) {
    ...
    Capture.call(this, dispatcher, false, opts);
  ...
  function Live(device, opts) {
    ...
    Capture.call(this, dispatcher, true, opts);
