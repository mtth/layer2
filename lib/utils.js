...
(function (root) {
   ...
   *
   * Also features a `finish` method to stop fetching batches. The stream will
   * be ended when the last batch is exhausted (which implies that several data
   * events can still be triggered after this call).
   *
