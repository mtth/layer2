...
var ADDON = (/* istanbul ignore next */ function () {
...
module.exports = {
  Wrapper: ADDON.Wrapper,
  loadPduType: loadPduType,
  stringifyAddress: ADDON.stringifyAddress
};
